...
import FilePreview from '@/_components/shared/forms/FilePreview';
import Typography from '@/_components/shared/Typography';
import { FileWithPreview } from '@/_types/components/Dropzone.type';
      ...
      {readOnly && !(files?.length > 0) ? (
        ...
        <Controller
          ...
          render={({ field }) => (
            <>
              <div
                className='focus:ring-dark-400 border-primary-800 group mt-1 rounded-xl border-2 border-dashed focus:outline-none'
                {...getRootProps()}
                ref={dropzoneRef}
              >
                ...
                >
                  <div className='space-y-1 text-center'>
                    ...
                    <p className='text-gray-500'>
                      Tarik dan letakkan berkas disini, atau klik untuk memilih
                      berkas
                    </p>
